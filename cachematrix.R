## Functions below are responsible for creating a special matrix and caching the inverse this matrix.
...
## The cacheSolve function calculates the inverse of the special "matrix" and caches the inverse. 
